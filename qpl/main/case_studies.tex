...
\label{eq:link-tn}
\end{equation}
The $X$-boxes have the following concrete interpretation:
...
{\bf for $d=2$ it's just the Pauli X so it's stabilizer.}
{\bf what does the $X$ matrix look like for $d=3$? Here it should not be a stabilizer, showing that ZX cannot efficiently do $3$-colouring which is \#P-complete. [ref]}
