...
Additively approximating the Jones polynomial at \emph{non-lattice roots of unity} is a paradigmatic BQP-complete complete problem \cite{Aharonov_2008,kuperberg2014hard}.
...
\begin{equation}
\includegraphics[scale=0.3, valign=c]{figures/link-tn.pdf}
\label{eq:link-tn}
\end{equation}
...
\begin{equation}\label{eq:G-tn}
	\includegraphics[scale=0.3, valign=c]{figures/G-tn.pdf}
\end{equation}
