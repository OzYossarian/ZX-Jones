...
Indeed, beyond quantum computing, ZX diagrams have been leveraged to study the complexity of boolean satisfiability (SAT) and model counting (\#SAT) \cite{debeaudrap2020tensor}.
...
% 2SAT is in P but \#2SAT is \#P-complete, whereas 3SAT is NP-complete and \#3SAT is \#P-hard.
% That is, the counting version of 2SAT is hard yet deciding is easy, but this is not the case for 3SAT, where both deciding and counting are hard.
