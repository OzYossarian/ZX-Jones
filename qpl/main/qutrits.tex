...
We now turn to the qutrit ZX-calculus and examine the analogous story to that of the previous section,
...
The full set of rules of the qutrit ZX-calculus is shown in Figure \ref{fig:qutrit_ZX_rules}, and a more rigorous definition of the calculus as a whole is found in Appendix \ref{app:qutrit_zx_calculus}.
% in Appendix \ref{app:zx_calculus}.
...
\begin{equation}\label{eq:bang_box}
