...
\end{equation}
The above equations hold also if we flip the colours, green $\leftrightarrow$ red. The full set of rules governing the qutrit ZX calculus is shown in Figure \ref{fig:qutrit_zx_rules}.
